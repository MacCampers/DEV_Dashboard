...
<head>
    ...
    <title>Equiteasy | @lang('errors.page_403.title')</title>
...
<body>
   ...
   <div id="main-wrapper">
      <div id="main" class="blue-pattern">
         <div id="error-page">
            <h1>@lang('errors.page_403.title')</h1>
            <p>@lang('errors.page_403.text')</p>

            <a href="{{ route('home') }}" class="button red">@lang('errors.page_403.button')</a>
         </div>
      </div>
