   ...
   <div id="register" class="blue-pattern">
      <div class="container">
         <div class="col-12">
            ...
            <form id="register-form" class="subscription" method="post" action="{{ route('register_user', ['type' => 'contractor']) }}" autocomplete="off">
               {{ csrf_field() }}
                        ...
                        <div class="row">
                           <div class="col-12">
                              <div class="plan-selector featured">
                                 <input type="radio" id="subscription-1" name="subscription" value="contractor_6"{{ old('subscription') === 'contractor_6' ? ' checked' : '' }} />
                              ...
                              <div class="plan-selector">
                                 <input type="radio" id="subscription-2" name="subscription" value="contractor"{{ old('subscription') === 'contractor' ? ' checked' : '' }} />
                           ...
                           <span class="blue-span">@lang('prices.contractor.flat_fee_contractor')</span>
                        </div>
